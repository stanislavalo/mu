export default [{
    ...
    {
        "id_grant": "153",
        "number_grant": "CZ.02.2.69/0.0/0.0/18_054",
        "from_date": "2018-01-01",
        "to_date": "2022-12-31",
        "title": "Matematický ústav AV ČR usiluje o HR Award - zavedení profesionálního řízení lidských zdrojů",
        "url_grant": null,
        "grantor": 'Ministerstvo školství, mládeže a tělovýchovy',
        "description": "Matematický ústav je přední českou věřejnou organizací, kterých posláním je vědecký výzkum v oblastech matematiky a jejích aplikací. Pro posílení jeho konkurenceschopnosti v mezinárodním kontextu je klíčové uvést dosavadní strategii řízení a rozvoje lidských zdrojů do souladu s Evropskou chartou pro výzkumné pracovníky, a tím umožnit získání ocenění HR Award. Pro ústav jde o mimořádnou příležitost, jak zkvalitnit a zprofesionalizovat péči o lidské zdroje, které jsou alfou a omegou jeho úspěchu.",
        "url_fichier": null,
        "titre_fichier": null,
        "activ": "1",
        "type_grant": "1",
