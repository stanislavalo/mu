export default [
  ...
  },
  {
    ...
    items:[
      {url:'/department/1', name:['Abstract Analysis (AA)','Abstraktní analýza (AA)']},
      {url:'/department/2', name:['Algebra, Geometry and Mathematical Physics (AGMP)',
        'Algebra, geometrie a matematická fyzika (AGMP)']},
      {url:'/department/3', name:['Branch in Brno (BB)','Pobočka v Brně (BB)']},
      {url:'/department/4', name:['Constructive Methods of Mathematical Analysis (CMMA)',
        'Konstruktivní metody matematické analýzy (CMMA)']},
      {url:'/department/5', name:['Evolution Differential Equations (EDE)',
      'Evoluční diferenciální rovnice (EDE)']},
      {url:'/department/6', name:['Mathematical Logic and Theoretical Computer Science (MLTCS)',
        'Matematická logika a teoretická informatika (MLTCS)']},
      {url:'/department/50', name:['Archive','Archiv']},
    ],
    dropdown:true,
    url:null
  },
